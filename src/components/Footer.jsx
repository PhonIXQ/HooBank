                  ...
                  <div key={footerLink.title} className="flex flex-col ss:my-0 my-4 min-w-[150px]">
                     ...
                     <ul className="list-none mt-4">
                        {footerLink.links.map((link, index) => (
                           <li key={link.name} className={`font-poppins font-normal text-[16px] leading-[24px] text-dimWhite hover:text-secondary cursor-pointer leading ${index !== footerLink.links.length - 1 ? 'mb-4' : 'mb-0'}`}>
                              <a href={link.link}>
                                 {link.name}</a>
                           </li>
                        ))}
         ...
         <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
            <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white">
               <span className="text-secondary">
                  <a href="https://github.com/PhonIXQ/HooBank">PhonIXQ</a></span>{" "}
               &copy; 2023 HooBank. All Rights Reserved.</p>
